...
export var Input = function (props) {
    ...
    return (_jsxs("div", __assign({ className: cnames, style: style }, { children: [prepend && _jsx("div", __assign({ className: "viking-input-group-prepend" }, { children: prepend }), void 0),
            icon && _jsx("div", __assign({ className: "icon-wrapper" }, { children: _jsx(Icon, { icon: icon, title: "title-" + icon }, void 0) }), void 0),
            _jsx("input", __assign({ className: "viking-input-inner", disabled: disabled }, restProps), void 0),
            append && _jsx("div", __assign({ className: "viking-input-group-append" }, { children: append }), void 0)] }), void 0));
};
