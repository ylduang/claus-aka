...
export var AutoComplete = function (props) {
    ...
    var generateDropdown = function () {
        return (_jsx(Transition, __assign({ in: showDropdown || loading, animation: "zoom-in-top", timeout: 300, onExited: function () { setSugestions([]); } }, { children: _jsxs("ul", __assign({ className: "viking-suggestion-list" }, { children: [loading &&
                        _jsx("div", __assign({ className: "suggstions-loading-icon" }, { children: _jsx(Icon, { icon: "spinner", spin: true }, void 0) }), void 0),
    ...
    return (_jsxs("div", __assign({ className: "viking-auto-complete", ref: componentRef }, { children: [_jsx(Input, __assign({ value: inputValue, onChange: handleChange, onKeyDown: handleKeyDown }, restProps), void 0), generateDropdown()] }), void 0));
};
